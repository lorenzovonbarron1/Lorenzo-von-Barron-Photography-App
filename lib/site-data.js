...
// LYNK placeholders — swap these two values when the real LYNK URLs
// land; every "Book / Enquire via LYNK" CTA in the app derives from them.
export const LYNK_BASE = "https://lynk.example/book/";
export const LYNK_HOME = "https://lynk.example/book";
