...
export const DISCIPLINES = [
  ...
  },
  {
    ...
    heroImage: "/images/automotive/green-car-wheel-sunset.jpg",
    heroLabel: "Automotive — Wheel, Sunset",
    // The featured panel runs 16:9 and wide; keep the crop on the
    // wheel and fender with a band of sunset to the right.
    heroObjectPosition: "56% 50%",
    heroAlt: "Close low-angle view of a green car with a silver wheel at sunset.",
    supportImages: [
...
export const ORBIT_ITEMS = [
  ...
  },
  {
    ...
    image: "/images/automotive/green-car-wheel-sunset.jpg",
    // Tall 9:16 source in the near-square card: hold the crop on the
    // wheel (centered slightly right) so fender, wheel, sunset, and a
    // little asphalt all stay in frame.
    objectPosition: "58% 46%",
    alt: "Close low-angle view of a green car with a silver wheel at sunset.",
  },
  {
    num: "04",
    title: "Portraits",
