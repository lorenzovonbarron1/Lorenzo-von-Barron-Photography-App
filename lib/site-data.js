...
export const DISCIPLINES = [
  ...
  },
  {
    ...
    // Featured panel runs wide (16:9 / 4:3) over a tall source, so only
    // the vertical anchor matters — hold the band on the wheel.
...
export const ORBIT_ITEMS = [
  ...
  },
  {
    ...
    // Wheel is the focal point — bias right so it stays framed, hold
    // vertical center to keep the fender/body up top, the sunset and
    // palms mid-right, and the asphalt at the bottom for breathing room.
